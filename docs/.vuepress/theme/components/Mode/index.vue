<template>
	<div v-click-outside="hideMenu" class="color-picker" v-if="$themeConfig.modePicker !== false" >
		<a class="color-button faa-spin animated" @click.prevent="showMenu = !showMenu">
			<i class="iconfont reco-color" :style="$themeConfig.fullscreen ?{'color':'rgba(79, 154, 89, 0.8)'}:{}"></i>
		</a>
